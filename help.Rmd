...
As long as your gene IDs follow the ATxGxxxxx format, they should be recognized by TF DEACoN. It does not matter what is in between the IDs (spaces, commas, etc.) or if they are on separate lines.

The total number and IDs of input genes which were recognized by TF DEACoN and used in the analysis are shown. You can use this information to confirm that all the genes from your query were recognized.
